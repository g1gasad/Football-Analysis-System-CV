...
import os
sys.path.append("../")
from utils import measure_distance, measure_xy_distance, get_foot_position, get_center_of_bbox
...
class CameraMovementEstimator:
    ...
    def get_camera_movement(self, frames, read_from_stub=False, stub_path=None):
        ...
        for frame_num in range(1, len(frames)):
            ...
            new_features, _, _ = cv2.calcOpticalFlowPyrLK(old_gray, frame_gray, old_features, None,
                                                    **self.lk_params)
